...
#pragma resource "*.dfm"
TForm_nova_tabela *Form_nova_tabela;
//---------------------------------------------------------------------------
__fastcall TForm_nova_tabela::TForm_nova_tabela(TComponent* Owner)
	: TForm(Owner)
{
	cancelado = false;
}
//---------------------------------------------------------------------------
void __fastcall TForm_nova_tabela::btnConfirmarClick(TObject *Sender)
{
	try
	{
...
//---------------------------------------------------------------------------
void __fastcall TForm_nova_tabela::btnCancelarClick(TObject *Sender)
{
	cancelado = true;
	Close();
}
