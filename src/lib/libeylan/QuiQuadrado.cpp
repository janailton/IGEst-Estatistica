...
#pragma comment( lib , "../alglib/alglib_cbuilder.lib" )

#include "QuiDuadrado.h"
#include "../alglib/include/chisquaredistr.h"


double Qui_Quadrado( double v , double x )
{
	return chisquarecdistribution( v , x );
}

double Qui_Quadrado_Inverso( double v , double p )
{
	return invchisquaredistribution( v , p );
}